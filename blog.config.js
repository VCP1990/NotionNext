...
const BLOG = {
  API_BASE_URL: process.env.API_BASE_URL || 'https://skillful-pewter-062.notion.site/api/v3', // API默认请求地址,可以配置成自己的地址例如：https://[xxxxx].notion.site/api/v3
  // Important page_id！！！Duplicate Template from  https://tanghh.notion.site/02ab3b8678004aa69e9e415905ef32a5
  NOTION_PAGE_ID:
    process.env.NOTION_PAGE_ID ||
    '2897f63200f080d0b298d55fea86e22d',
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'Pao', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || 'Knowledge Builder | PhD Biotechnology | Life Science Industy Expert | Financial Modeling & Deal Execution | Python & AI Literacy for Data-Optimized Industry Research', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://paoresearch.uk/', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'Industry Research, Knowledge Sharing', // 网站关键词 英文逗号隔开
  ...
  GREETING_WORDS:
    ...
    'Hi，Welcome to Pao Research, This blog is a platform for sharing my views and insights. Enjoy Reading 🎉',
